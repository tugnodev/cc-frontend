<script lang="ts">
  ...
  import { X, Pencil, Trash2, Plus, ArrowUp, ArrowDown, ChevronsUpDown, Image as ImageIcon } from "@lucide/svelte";
  import ModalBox from "./ModalBox.svelte";
  import type { articleDto, createArticleDto, updateAticleDto, } from "../services/dtos/article";
  import { articles as articleStore, addArticle, removeArticle, updateArticle } from "../store/articles";
  ...
  function confirmDelete(a: articleDto) { toDelete = a; }
                  ...
                  <div class="flex items-center justify-end gap-0.5 md:gap-1">
                    ...
                    {#if sortKey === "price"}
                      {#if sortDir === 1}<ArrowUp
                          class="w-4 h-4"
                        />{:else}<ArrowDown class="w-4 h-4" />{/if}
                    {:else}
                    ...
                    <td class="text-center font-semibold">
                      ...
                      {:else if a.stock < 10}
                        <div class="text-warning badge-warning gap-1">
                          {a.stock}
                          <span class="hidden lg:inline ml-1 text-xs opacity-70"
                            >(Faible)</span
                          >
                        </div>
                      {:else}
          ...
          <div class="flex flex-col gap-3">
            ...
            <div class="form-control">
              <label class="label" for="images"
                ><span class="label-text font-medium">Images du produit</span
                ></label
              >
            ...
            <div class="grid grid-cols-2 gap-4">
              <div class="form-control">
                <label class="label" for="price"
                  ><span class="label-text font-medium">Prix (F CFA) *</span
                  ></label
                >
            ...
            <div class="form-control">
              <label class="label" for="categories"
                ><span class="label-text font-medium">Catégories</span></label
              >
      ...
      {#snippet children()}
        <div class="w-full p-4">
          ...
          <div class="modal-action">
            <button class="btn btn-ghost" on:click={() => (toDelete = null)}
              >Annuler</button
            >
