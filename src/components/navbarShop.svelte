<script lang="ts">
    import { ShoppingCart, LayoutDashboard, Package } from "@lucide/svelte";
    ...
    const navItems = [
        ...
        { label: "Commande", href: "/shop/commande", icon: ShoppingCart },
        { label: "Article", href: "/shop/article", icon: Package },
    ];
</script>
